...
| Lab homepage — publication DOI/journal links | `/publication` and `/publication/2021-before-hyu` | Per-paper DOI/journal-page URL, fetched 2026-07-20, used for the clickable "journal name" button next to each title in `publications.html` and for the 5 Highlights thumbnails that now link straight to the paper instead of opening the lightbox. 4 very recent in-press papers (#116, #115, #114, #112) had no link on the homepage yet, so their venue stayed a plain (non-clickable) badge — don't invent a DOI for these. One scrape mismatch was caught and corrected by cross-checking a search engine: paper #37 ("Metal Halide Perovskites: From Crystal Formations...", *Small Methods* 2018) had been given paper #42's URL; corrected to `10.1002/smtd.201800093`. |
| Lab homepage — news photos | `/news` | 13 photos/figures in `assets/img/news/`, captured 2026-07-17 |
| Lab homepage — news outbound press links | `/news` | Per-item outlet hyperlinks (e.g. Hankyoreh, News H/newshyu.com, EurekAlert), fetched 2026-07-22 and applied in `news.html` so each outlet name links to the original article/press page instead of being plain text. Page-head and news-item copy translated to Korean at the same time; nav/footer and the other 6 pages stay English. |
